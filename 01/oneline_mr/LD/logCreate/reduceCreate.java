...
public class reduceCreate extends Reducer<IntWritable, Text , Text, NullWritable> {
    Text result = new Text();
    Text empty_text = new Text("");


    public void reducer(IntWritable	key, Iterable<Text> logs_raw, Context context) throws IOException,InterruptedException {
